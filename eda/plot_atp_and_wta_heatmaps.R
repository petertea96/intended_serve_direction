# --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || 
# --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || --- || 
# -- Plot 3 ATP and 3 WTA players serve heatmaps ----
...
atp_training_data <- read.csv('.//data/atp_processed_roland_garros_tracking_data.csv',
                              stringsAsFactors = FALSE)

wta_training_data <- read.csv('./data/wta_processed_roland_garros_tracking_data.csv',
                              stringsAsFactors = FALSE)
