...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
# -- Plot Player Intercepts (Wide vs T) for Model 2 
# -- Plot tranformed intercept from logit scale --> probability scale
# -- Note: We probably could have used the results from the original fit of 
# -- model 2. But, STAN has some functionailty in its transformed parameter
#    block that gives all results on the probability scale.
